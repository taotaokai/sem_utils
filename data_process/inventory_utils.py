...
# NOTE this is modified from pyasdf (https://github.com/SeismicData/pyasdf.git: pyasdf/inventory_utils.py)

# Changes:
#   1) isolate_and_merge_station(..., ignore_station_creation_date: bool = False): allow ignore createion date during merging stations
#   2) _merge_channel(...): allow merge channels with the same contents but different start/end date
