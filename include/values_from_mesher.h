 ...
 !
 ! maximum number of points per region =       545553
 !
 ! on NEC SX, make sure "loopcnt=" parameter
 ! in Makefile is greater than max vector length =      1636659
 !
 ! total elements per slice =         9376
 ! total points per slice =       628323
 !
 ...
 ! -----------------------------------------
 !
 ! angular size in first direction in degrees =    10.0000000    
 ! angular size in second direction in degrees =    10.0000000    
 !
 ! longitude of center in degrees =    0.00000000    
 ! latitude of center in degrees =    0.00000000    
 !
 ! angle of rotation of the first chunk =    0.00000000    
 !
 ! corner            1
 ! longitude in degrees =   -4.9999999999999947     
 ! latitude in degrees =   -5.0142959765683663     
 !
 ! corner            2
 ! longitude in degrees =    5.0000000000000000     
 ! latitude in degrees =   -5.0142959765683663     
 !
 ! corner            3
 ! longitude in degrees =   -4.9999999999999947     
 ...
 !
 ! size of static arrays per slice =    376.73149599999999       MB
 !                                 =    359.27915191650391       MiB
 !                                 =   0.37673149600000000       GB
 !                                 =   0.35085854679346085       GiB
 !
 ...
 !
 ! size of static arrays for all slices =    1506.9259840000000       MB
 !                                      =    1437.1166076660156       MiB
 !                                      =    1.5069259840000000       GB
 !                                      =    1.4034341871738434       GiB
 !                                      =    1.5069259840000001E-003  TB
 !                                      =    1.3705411984119564E-003  TiB
 !

 integer, parameter :: NEX_XI_VAL =           32
 integer, parameter :: NEX_ETA_VAL =           32

 integer, parameter :: NSPEC_CRUST_MANTLE =         8192
 integer, parameter :: NSPEC_OUTER_CORE =         1120
 integer, parameter :: NSPEC_INNER_CORE =           64

 integer, parameter :: NGLOB_CRUST_MANTLE =       545553
 integer, parameter :: NGLOB_OUTER_CORE =        77857
 integer, parameter :: NGLOB_INNER_CORE =         4913

 integer, parameter :: NSPECMAX_ANISO_IC =            1

 integer, parameter :: NSPECMAX_ISO_MANTLE =         8192
 ...
 integer, parameter :: NSPEC_CRUST_MANTLE_STR_OR_ATT =         8192
 integer, parameter :: NSPEC_INNER_CORE_STR_OR_ATT =           64

 integer, parameter :: NSPEC_CRUST_MANTLE_STR_AND_ATT =            1
 integer, parameter :: NSPEC_INNER_CORE_STR_AND_ATT =            1

 integer, parameter :: NSPEC_CRUST_MANTLE_STRAIN_ONLY =         8192
 integer, parameter :: NSPEC_INNER_CORE_STRAIN_ONLY =           64

 integer, parameter :: NSPEC_CRUST_MANTLE_ADJOINT =         8192
 integer, parameter :: NSPEC_OUTER_CORE_ADJOINT =         1120
 integer, parameter :: NSPEC_INNER_CORE_ADJOINT =           64
 integer, parameter :: NGLOB_CRUST_MANTLE_ADJOINT =       545553
 integer, parameter :: NGLOB_OUTER_CORE_ADJOINT =        77857
 integer, parameter :: NGLOB_INNER_CORE_ADJOINT =         4913
 integer, parameter :: NSPEC_OUTER_CORE_ROT_ADJOINT =            1

 integer, parameter :: NSPEC_CRUST_MANTLE_STACEY =         8192
 ...
 integer, parameter :: NSPEC2DMAX_XMIN_XMAX_IC =           16
 integer, parameter :: NSPEC2DMAX_YMIN_YMAX_IC =           16
 ...
 integer, parameter :: NGLOB_XY_CM =       545553
 ...
 integer, parameter :: NT_DUMP_ATTENUATION =          259

 double precision, parameter :: ANGULAR_WIDTH_ETA_IN_DEGREES_VAL =    10.000000
 double precision, parameter :: ANGULAR_WIDTH_XI_IN_DEGREES_VAL =    10.000000
