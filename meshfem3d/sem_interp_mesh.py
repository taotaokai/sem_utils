...
from meshfem3d_utils import sem_mesh_interp_single_slice
...
def parse_arguments():
    parser = argparse.ArgumentParser(
        description="Create horizontal slice of SEM model at a given depth"
    )
    ...
    parser.add_argument("model_dir_target", help="model dir for background model values")

    parser.add_argument("out_dir", help="output model dir")
