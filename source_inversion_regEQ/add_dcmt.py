...
parser.add_argument("dcmt_file_dxs") # dxs.cmt
parser.add_argument("dcmt_file_dmt") # dmt.cmt
parser.add_argument("out_cmt_file_dxs") # CMTSOLUTION_dxs
parser.add_argument("out_cmt_file_dmt") # CMTSOLUTION_dmt
