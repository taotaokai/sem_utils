...
!//////////////////////////
subroutine sem_read_modeln(model_array, basedir, iproc, iregion, nmodel, model_names)
...
!//////////////////////////
subroutine sem_write_modeln(model_array, basedir, iproc, iregion, nmodel, model_names)
