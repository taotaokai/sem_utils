subroutine selfdoc()
  ...
  print '(a)', "NAME"
  print '(a)', ""
  print '(a)', "  xsem_kernel_aijkl_to_tiso_in_alpha_beta_xi_scale_phi_eta_to_xi"
  print '(a)', "    - reduce aijkl kernel to TI kernel (alpha,beta,xi) with scaling phi,eta to xi"
  print '(a)', ""
  print '(a)', "SYNOPSIS"
  print '(a)', ""
  print '(a)', "  xsem_kernel_aijkl_to_tiso_in_alpha_beta_xi_scale_phi_eta_to_xi \"
  print '(a)', "    <nproc> <mesh_dir> <model_dir> <kernel_dir> <scale_phi> <scale_eta> <out_dir>"
  print '(a)', ""
  print '(a)', "DESCRIPTION"
  print '(a)', ""
  ...
  print '(a)', "  (string) model_dir:  directory holds the model files, proc*_reg1_[vp0,vs0,alpha,beta,xi].bin"
  print '(a)', "  (string) kernel_dir:  directory holds the aijkl_kernel files"
  print '(a)', "                        proc******_reg1_aijkl_kernel.bin"
  print '(a)', "  (string) out_dir:  output directory for [alpha,beta,xi]_kernel"
  print '(a)', ""
  print '(a)', "NOTE"
  print '(a)', ""
...
program xsem_kernel_aijkl_to_tiso
  ...
  read(args(5), *) scale_phi
  read(args(6), *) scale_eta 
  ...
  do iproc = myrank, (nproc-1), nrank
    ...
    ! scaled anisotropic parameters
    phi = scale_phi*xi
    eta = 1.0 - scale_eta*xi
    ...
    ! combine phi,eta kernel into xi kernel via the scaling factors
    xi_kernel = xi_kernel + scale_phi*phi_kernel - scale_eta*eta_kernel
    print *, "xi_kernel(scale phi,eta): min/max=", minval(xi_kernel), maxval(xi_kernel)
