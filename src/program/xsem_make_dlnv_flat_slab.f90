subroutine selfdoc()
  ...
  print '(a)', "NAME"
  print '(a)', ""
  print '(a)', "  xsem_make_dlnv_flat_slab "
  print '(a)', "    - make gll model for a flat slab "
  print '(a)', ""
  print '(a)', "SYNOPSIS"
  print '(a)', ""
  print '(a)', "  xsem_make_dlnv_flat_slab \"
  ...
  print '(a)', "    <slab_strike> <slab_half_width>"
  print '(a)', "    <flat_slab_len> <flat_slab_thickness> "
  print '(a)', "    <slab_dlnv> <flag_ellipticity> <out_tag> <out_dir> "
  print '(a)', ""
  print '(a)', "DESCRIPTION"
  print '(a)', ""
  print '(a)', "  A flat slab at a certain depth" 
  print '(a)', ""
  print '(a)', "PARAMETERS"
  print '(a)', ""
  print '(a)', "  (int) nproc:  number of mesh slices"
  print '(a)', "  (string) mesh_dir:  directory containing proc000***_reg1_solver_data.bin"
  print '(a)', "  (float) origin_lat/lon/depth (deg/km): origin point at the middle edge of the flat slab's bottom plane"
  print '(a)', "  (float) slab_strike:  subducting slab strike angles(deg)"
  print '(a)', "  (float) slab_half_width:  slab half width along the strike direction(km)"
...
program xsem_add_model_stagnant_slab_with_gap
  ...
  real(dp) :: slab_strike, slab_half_width
  real(dp) :: flat_slab_len, flat_slab_thickness, slab_dlnv
  ...
  read(args(6), *) slab_strike
  read(args(7), *) slab_half_width
  read(args(8), *) flat_slab_len
  read(args(9), *) flat_slab_thickness
  read(args(10), *) slab_dlnv
  read(args(11), *) flag_ellipticity
  read(args(12), '(a)') out_tag
  ...
  flat_slab_angular_width = flat_slab_len/(EARTH_R_KM - origin_depth)
