subroutine selfdoc()
  ...
  print '(a)', "  3. radd: add relative difference into a reference model (V1 + 1)*V2"

end subroutine


!///////////////////////////////////////////////////////////////////////////////
program xsem_math_serial
  ...
  do iproc = 0, nproc-1
    ...
    call sem_io_read_gll_file_n(model_dir_1, iproc, iregion, model_names_1, nmodel, gll_model_1)

    call sem_io_read_gll_file_n(model_dir_2, iproc, iregion, model_names_2, nmodel, gll_model_2)
