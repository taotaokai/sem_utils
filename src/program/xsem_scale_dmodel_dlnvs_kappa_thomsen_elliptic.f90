subroutine selfdoc()
  print '(a)', "NAME"
  print '(a)', ""
  print '(a)', "  xsem_scale_dmodel_dlnvs_kappa_thomsen_elliptic"
  ...
  print '(a)', "  (string) model_suffix:  proc000***_reg1_[dlnvs,kappa,eps,gamma]<model_suffix>.bin"
  print '(a)', "  (float) max_dlnvs:  maximum abs(dlnvs) "
  print '(a)', "  (string) out_dir:  out directory "
  print '(a)', "  (string) out_suffix:  proc000***_reg1_[dlnvs,kappa,eps,gamma]<out_suffix>.bin"
  print '(a)', ""
  print '(a)', "NOTE"
  print '(a)', ""
