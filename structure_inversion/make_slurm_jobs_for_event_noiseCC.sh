...
# FORCESOLUTION file
force_file=$event_dir/DATA/FORCESOLUTION
if [ ! -f "$force_file" ]
then
...
#echo
#
#$sem_utils_dir/waveform_der_dmodel.py $misfit_par $db_file $event_dir/output_perturb/sac model
#
#$sem_utils_dir/grid_search_dmodel.py $misfit_par $db_file $misfit_dir/grid_search_dmodel.txt
#
#echo
#echo "Done: JOB_ID=\${SLURM_JOB_ID} [\$(date)]"
#echo
...
#  
#  $sem_utils_dir/output_adj_for_perturbed_waveform.py \
#    $misfit_par \
#    $db_file \
