...
# |
# |-STATION_<net>_<sta>/
#        |-SYN_t0_t1[0:ncomp, 0:npts]
#        |          |-attrs: starttime, sampling_interval
#        |          |
#        |-GRN_t0_t1[0:ncomp, 0:npts]
#        |          |-attrs: starttime, sampling_interval
#        |-MISFIT_WINDOW/
#                   | Z_t0_t1/
...
#======================================================
  def __init__(self, h5f):
    ...
    assert(type(h5f) is tables.file.File)
    self.h5f = h5f
    # self.h5f = tables.open_file(h5_file, mode="a")
...
#======================================================
  def add_event(self, cmt_file, isECEF=False):
    """
    Read in CMTSOLUTION
    """
    self.event.read_cmtsolution(cmt_file, isECEF=isECEF)

#======================================================
  def add_stations(self, data_h5file):
    #------ read station file
    with tables.open_file(data_h5file, mode="r") as h5f:
        for net_sta_g in h5f.root:
            self.h5f.root
...
#======================================================
  ...
  def plot_seismogram_3comp(self, data_file_h5,
      savefig=False, out_dir='plot',
      plot_param={
        'time':[0,100], 'rayp':10., 'azbin':10, 'window_id':'F.p,P',
        'SNR':None, 'CC0':None, 'CCmax':None, 'dist':None }
    ...
    import tables as pt
    try:
        data = pt.open_file(data_file_h5, mode="r")
    except Exception as err:
        print(f'[Error] cannot open {data_file_h5}\n{err}')
        return

    event = data.root._v_attrs['event']
