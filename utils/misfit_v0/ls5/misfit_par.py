...
def make_window_list_surface_wave(evdp_km):
  ...
  if evdp_km <= 150:
    window_list_surface_wave = [
       {'phase':'surface', 'component':'Z', 'time':[-150,150], 'slowness':[24,33], 'filter':[flo, fhi, 2]},
       {'phase':'surface', 'component':'R', 'time':[-150,150], 'slowness':[24,33], 'filter':[flo, fhi, 2]},
       {'phase':'surface', 'component':'T', 'time':[-150,150], 'slowness':[24,33], 'filter':[flo, fhi, 2]},
       ]
  else:
    window_list_surface_wave = []
