...
#./configure FC=mpif90 MPIFC=mpif90 FCFLAGS="-fc=ifort -O3" CC=icc
#./configure FC=mpif90 MPIFC=mpif90 FCFLAGS="-O3 -lpthread -fc=ifort" CC=icc CFLAGS="-O3 -rpath"
./configure FC=mpif90 MPIFC=mpif90 FC=ifort CC=icc
