subroutine selfdoc()
  ...
  print '(a)', "NAME"
  print '(a)', ""
  print '(a)', "  xsem_make_dlnv_stagnant_slab "
  print '(a)', "    - add stagnant slab into SEM model"
  print '(a)', ""
  print '(a)', "SYNOPSIS"
  print '(a)', ""
  ...
  print '(a)', "DESCRIPTION"
  print '(a)', ""
  print '(a)', "  A planar dipping slab that deflects and flattens at a certain depth (stagnant slab)" 
  print '(a)', ""
  print '(a)', "PARAMETERS"
  print '(a)', ""
